...
export default function ResultsDashboard({
  ...
  return (
    <div className="w-full max-w-2xl mx-auto px-4 pb-20 flex flex-col gap-6">
      ...
      <div ref={captureRef} className="flex flex-col gap-6 bg-bg-primary" style={{ backgroundColor: "#0a0a0f" }}>
        {/* 1. Header */}
        <Section index={0}>
          <div className="flex flex-col items-center text-center gap-3 pt-6 pb-2">
            <p className="font-mono text-xs text-text-muted tracking-widest">SENTI.AI — EMOTIONAL DAMAGE REPORT</p>
            <GlitchText text={result.headline} as="h2" className="text-2xl sm:text-3xl font-bold leading-tight max-w-xl" />
            <span
      ...
      {/* 9. Actions (NOT captured in screenshot) */}
      <Section index={8}>
        <div className="flex flex-col gap-3">
          <Button
            variant="primary"
